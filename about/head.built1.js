...
}return b}}},{}],3:[function(q,r,o){var u=q("./shared/stylePropertyCache");var n=q("./shared/getStyleTestElement");
...
}return s(c,f[a])}}return s(c,false)}},{"./shared/getStyleTestElement":5,"./shared/prefixHelper":6,"./shared/stylePropertyCache":7,"./utils/toCSS":9,"./utils/toDOM":10}],4:[function(t,v,q){var s=t("./getStyleProperty");
...
}},{"./getStyleProperty":3,"./shared/prefixHelper":6,"./shared/stylePropertyCache":7,"./shared/styleValueAvailable":8}],5:[function(k,j,g){var i;
j.exports=function h(){if(!i){i=document.createElement("_")}else{i.style.cssText="";
i.removeAttribute("style")}return i};j.exports.resetElement=function(){i=null}},{}],6:[function(j,p,k){var l=["-webkit-","-moz-","-ms-"];
...
this.dom=[this.dom[a]];this.evt=[this.evt[a]]}};p.exports=new q()},{}],7:[function(d,g,f){g.exports={}
},{}],8:[function(s,t,r){var u=s("./stylePropertyCache");var q=s("./getStyleTestElement");
...
}},{"./getStyleTestElement":5,"./stylePropertyCache":7}],9:[function(k,j,g){var i=/^(webkit|moz|ms)/gi;
...
}},{}],10:[function(g,k,h){var i=/-([a-z])/g;k.exports=function j(a){var b;if(a.toLowerCase()==="float"){return"cssFloat"
}a=a.replace(i,function(c,d){return d.toUpperCase()});if(a.substr(0,2)==="Ms"){a="ms"+a.substring(2)
}return a}},{}],11:[function(o,n,i){var l=o("@marcom/ac-prefixer/getStyleValue");
...
n.exports.original=j},{"@marcom/ac-function/memoize":1,"@marcom/ac-prefixer/getStyleProperty":3,"@marcom/ac-prefixer/getStyleValue":4}],12:[function(d,g,f){g.exports={getWindow:function(){return window
},getDocument:function(){return document},getNavigator:function(){return navigator
}}},{}],13:[function(m,l,h){var j=m("./helpers/globals");var k=m("@marcom/ac-function/once");
function i(){var a=j.getDocument();return !!a.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1")
}l.exports=k(i);l.exports.original=i},{"./helpers/globals":12,"@marcom/ac-function/once":2}],14:[function(m,l,h){var j=m("./helpers/globals");
...
}l.exports=k(i);l.exports.original=i},{"./helpers/globals":12,"@marcom/ac-function/once":2}],15:[function(F,K,t){var C=K.exports={};
...
}},{}],16:[function(n,m,i){var l=n("./ac-browser/BrowserData");var j=/applewebkit/i;
...
};k.exports=i},{"./data":19,"@marcom/ac-polyfills/Array/prototype.filter":"@marcom/ac-polyfills/Array/prototype.filter","@marcom/ac-polyfills/Array/prototype.some":"@marcom/ac-polyfills/Array/prototype.some"}],18:[function(d,g,f){g.exports={getDocumentMode:function(){var a;
...
return}for(c=0;c<a.length;c++){j(b,a[c])}}},{"./className/add":21,"@marcom/ac-polyfills/Array/prototype.slice":"@marcom/ac-polyfills/Array/prototype.slice","@marcom/ac-polyfills/Element/prototype.classList":"@marcom/ac-polyfills/Element/prototype.classList"}],21:[function(g,k,h){var j=g("./contains");
...
return}for(c=0;c<a.length;c++){g(b,a[c])}}},{"./className/remove":24,"@marcom/ac-polyfills/Array/prototype.slice":"@marcom/ac-polyfills/Array/prototype.slice","@marcom/ac-polyfills/Element/prototype.classList":"@marcom/ac-polyfills/Element/prototype.classList"}],26:[function(k,j,g){k("@marcom/ac-polyfills/Array/prototype.forEach");
...
}}}});return b}},{"@marcom/ac-polyfills/Array/prototype.forEach":"@marcom/ac-polyfills/Array/prototype.forEach"}],27:[function(j,p,k){var n=j("@marcom/ac-classlist/add");
...
}}};p.exports=q},{"@marcom/ac-classlist/add":20,"@marcom/ac-classlist/remove":25,"@marcom/ac-object/extend":26}],28:[function(q,r,p){var k="data-focus-method";
...
};o._onWindowBlur=function(a){this._focusMethod=false};r.exports=n},{}],29:[function(m,k,h){m("@marcom/ac-polyfills");
...
})}},{"./FeatureDetect":27,"./FocusManager":28,"./defaultTests":30,"@marcom/ac-polyfills":"@marcom/ac-polyfills"}],30:[function(m,l,n){var k=m("@marcom/ac-browser");
...
},{"@marcom/ac-browser":16,"@marcom/ac-feature/svgAvailable":13,"@marcom/ac-feature/touchAvailable":14}],31:[function(d,g,f){(function(l){if(!l.console){l.console={}
...
}}})(typeof window==="undefined"?this:window)},{}],32:[function(g,k,h){var j=g("./promise/promise").Promise;
var i=g("./promise/polyfill").polyfill;h.Promise=j;h.polyfill=i},{"./promise/polyfill":36,"./promise/promise":37}],33:[function(m,l,h){var i=m("./utils").isArray;
...
},{}],45:[function(f,i,g){var h={ua:window.navigator.userAgent,platform:window.navigator.platform,vendor:window.navigator.vendor};
i.exports=f("./parseUserAgent")(h)},{"./parseUserAgent":48}],46:[function(d,g,f){g.exports={browser:{safari:false,chrome:false,firefox:false,ie:false,opera:false,android:false,edge:false,version:{name:"",major:0,minor:0,patch:0,documentMode:false}},os:{osx:false,ios:false,android:false,windows:false,linux:false,fireos:false,chromeos:false,version:{name:"",major:0,minor:0,patch:0}}}
},{}],47:[function(d,g,f){g.exports={browser:[{name:"edge",userAgent:"Edge",version:["rv","Edge"],test:function(a){return(a.ua.indexOf("Edge")>-1||a.ua==="Mozilla/5.0 (Windows NT 10.0; Win64; x64)")
...
},{}],48:[function(r,s,p){var q=r("./defaults");var m=r("./dictionary");function n(a){return new RegExp(a+"[a-zA-Z\\s/:]+([0-9_.]+)","i")
...
return b}s.exports=l},{"./defaults":46,"./dictionary":47}],49:[function(o,m,i){var n=o("@marcom/ac-useragent");
var k=o("@marcom/ac-headjs");var j=o("@marcom/ac-feature/cssPropertyAvailable");
var l=function(){return{initialize:function b(){this.polyfillPerformance();var h=j("mask-image","linear-gradient(#000, #fff)");
var G=!h&&n.browser.firefox;var B=h||G;k.addTests({"css-backdrop-filter":j("backdrop-filter"),"css-transform":j("transform"),"css-object-fit":j("object-fit"),"css-position-sticky":j("position","sticky"),"css-mask":h,"css-clip-path":G,"css-mask-or-clip-path":B,ie:function z(){return n.browser.ie
},edge:function f(){return n.browser.edge},firefox:function D(){return n.browser.firefox
},safari:function y(){return n.browser.safari},ios:function d(){return n.os.ios
},android:function g(){return n.os.android},"old-safari":function A(){return n.browser.safari&&n.browser.version.major===9
},"ios-safari-9":function C(){return n.os.ios&&n.browser.safari&&n.browser.version.major===9
},"desktop-safari-9":function E(){return n.browser.safari&&n.browser.version.major<=9.5
},"ios-safari-10":function F(){return n.os.ios&&n.browser.safari&&n.browser.version.major===10
},progressive:function c(){if(n.browser.ie&&n.browser.version.major<9){return false
}return true}});k.htmlClass();return this},polyfillPerformance:function a(){if("performance" in window==false){window.performance={}
}else{return}Date.now=Date.now||function(){return new Date().getTime()};if("now" in window.performance==false){var c=Date.now();
if(performance.timing&&performance.timing.navigationStart){c=performance.timing.navigationStart
}window.performance.now=function d(){return Date.now()-c}}}}}();window.progressiveTimeout=setTimeout(function(){document.documentElement.classList.remove("progressive");
document.documentElement.classList.remove("progressive-image")},8000);m.exports=l.initialize()
},{"@marcom/ac-feature/cssPropertyAvailable":11,"@marcom/ac-headjs":29,"@marcom/ac-useragent":45}],"@marcom/ac-polyfills/Array/from":[function(d,g,f){if(!Array.from){Array.from=(function(){var c=Object.prototype.toString;
...
},{"es6-promise":32}],"@marcom/ac-polyfills/String/prototype.trim":[function(i,h,f){if(!String.prototype.trim){String.prototype.trim=function g(){return this.replace(/^\s+|\s+$/g,"")
...
},{"console-polyfill":31}],"@marcom/ac-polyfills/getComputedStyle":[function(l,k,m){if(!window.getComputedStyle){function j(d,a,b){d.document;
...
},{"html5shiv/src/html5shiv":42}],"@marcom/ac-polyfills/matchMedia":[function(d,g,f){d("matchmedia-polyfill");
d("matchmedia-polyfill/matchMedia.addListener")},{"matchmedia-polyfill":44,"matchmedia-polyfill/matchMedia.addListener":43}],"@marcom/ac-polyfills/performance/now":[function(d,g,f){
/*! MIT License
 *
...
},{"./Array":"@marcom/ac-polyfills/Array","./CustomEvent":"@marcom/ac-polyfills/CustomEvent","./Date":"@marcom/ac-polyfills/Date","./Element":"@marcom/ac-polyfills/Element","./Function":"@marcom/ac-polyfills/Function","./JSON":"@marcom/ac-polyfills/JSON","./Object":"@marcom/ac-polyfills/Object","./Promise":"@marcom/ac-polyfills/Promise","./String":"@marcom/ac-polyfills/String","./XMLHttpRequest":"@marcom/ac-polyfills/XMLHttpRequest","./console.log":"@marcom/ac-polyfills/console.log","./getComputedStyle":"@marcom/ac-polyfills/getComputedStyle","./html5shiv":"@marcom/ac-polyfills/html5shiv","./matchMedia":"@marcom/ac-polyfills/matchMedia","./performance":"@marcom/ac-polyfills/performance","./requestAnimationFrame":"@marcom/ac-polyfills/requestAnimationFrame"}]},{},[49]);