...
var chart_labels = ['理1','理2','理3','理4','理5','理6','理7','理8','理9','理10','理11','理12','理13','理14','文1','文2','文3','文4','文5','年级'];
    var chart_data = [ <?php echo($l1['avg'].','.$l2['avg'].','.$l3['avg'].','.$l4['avg'].','.$l5['avg'].','.$l6['avg'].','.$l7['avg'].','.
    $l8['avg'].','.$l9['avg'].','.$l10['avg'].','.$l11['avg'].','.$l12['avg'].','.$l13['avg'].','.$l14['avg'].','.$w1['avg'].','.
    $w2['avg'].','.$w3['avg'].','.$w4['avg'].','.$w5['avg'].','.$all['avg']);?>];
