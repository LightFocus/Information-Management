...
<body class="sidebar-mini">
              ...
              <div class="card-header">
                <div class="row">
                  <div class="col-sm-6 text-left">
                    ...
                    <h2 class="card-title"><?php echo($sub1);?>平均成绩</h2>
                  </div>
                </div>
              </div>
              <div class="card-body">
  ...
  <?php
     ...
     if($_SESSION["account"]=="eng"){
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理1'");
       $l1 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理2'");
       $l2 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理3'");
       $l3 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理4'");
       $l4 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理5'");
       $l5 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理6'");
       $l6 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理7'");
       $l7 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理8'");
       $l8 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理9'");
       $l9 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理10'");
       $l10 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理11'");
       $l11 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理12'");
       $l12 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理13'");
       $l13= $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='理14'");
       $l14 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='文1'");
       $w1 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='文2'");
       $w2 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='文3'");
       $w3 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='文4'");
       $w4 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students where class='文5'");
       $w5 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(English) as avg FROM students");
       $all = $stmt->fetch(PDO::FETCH_ASSOC);
     }else if($_SESSION["account"]=="pro"){
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理1'");
       $l1 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理2'");
       $l2 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理3'");
       $l3 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理4'");
       $l4 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理5'");
       $l5 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理6'");
       $l6 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理7'");
       $l7 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理8'");
       $l8 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理9'");
       $l9 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理10'");
       $l10 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理11'");
       $l11 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理12'");
       $l12 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理13'");
       $l13= $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='理14'");
       $l14 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='文1'");
       $w1 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='文2'");
       $w2 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='文3'");
       $w3 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='文4'");
       $w4 = $stmt->fetch(PDO::FETCH_ASSOC);
       $stmt = $pdo->query("SELECT AVG(Programming) as avg FROM students where class='文5'");
       $w5 = $stmt->fetch(PDO::FETCH_ASSOC);
